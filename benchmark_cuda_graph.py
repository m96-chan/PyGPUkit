...
from pygpukit.llm import (
    ChatMessage, detect_model_spec, format_chat_messages,
    load_model_from_safetensors, load_safetensors,
)
...
_ = model.generate_cuda_graph(
    input_ids, max_new_tokens=4, max_seq_len=MAX_SEQ_LEN,
    temperature=0.7, top_k=50, top_p=0.9, use_graph=False
)
