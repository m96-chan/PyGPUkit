/**
 * TF32 TensorCore GEMM v2 - Exact v1 copy with BK=16 as baseline
 *
 * Target: 90%+ of cuBLAS performance (37.6+ TFLOPS on RTX 3090 Ti)
 *
 * This is a copy of v1's proven kernel. We'll optimize from here.
 */
...
// ============================================================
// Main kernel - copy of v1 for comparison
// ============================================================
...
sgemm_tf32_v2_kernel(
    ...
    for (int wm = 0; wm < WARP_TILES_M; ++wm) {
        ...
        for (int wn = 0; wn < WARP_TILES_N; ++wn) {
            ...
            // Use float2 for better memory throughput
